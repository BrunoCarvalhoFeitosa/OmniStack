...
//Function to render incidents page
function Incidents() {
    ...
    //Function to navigate to detail page of incident
    function navigateToDetail(incident) {
        navigation.navigate('Details', { incident });
    }

    //Function to load incident from API, generate total incidents and infinite scroll
    ...
    //Function to generate incidents in fits load of page
    useEffect(() => {
        loadIncidents();
    }, [])
